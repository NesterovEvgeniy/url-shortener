...
Проект содержит автоматические тесты, охватывающие основную функциональность:

- **Тесты аутентификации**: Регистрация, вход, проверка токенов
- **Тесты ссылок**: Создание, получение, обновление, удаление, перенаправление
- **Тесты кэширования**: Проверка работы Redis-кэша
- **Тесты проектов**: Группировка ссылок по проектам
- **Тесты поиска**: Поиск ссылок по оригинальному URL
